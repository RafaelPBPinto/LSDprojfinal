...
SIGNAL \u3|s_state.E0~feeder_combout\ : std_logic;
...
SIGNAL \u2|s_counter[20]~1_combout\ : std_logic;
...
SIGNAL \u1|visor_uni~4_combout\ : std_logic;
...
\u3|s_state.E0~feeder\ : cycloneive_lcell_comb
-- Equation(s):
-- \u3|s_state.E0~feeder_combout\ = \KEY[0]~input_o\
...
PORT MAP (
	datad => \KEY[0]~input_o\,
	combout => \u3|s_state.E0~feeder_combout\);
...
PORT MAP (
	...
	d => \u3|s_state.E0~feeder_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \u3|s_state.E0~q\);
...
-- Equation(s):
-- \u3|s_state~20_combout\ = (\KEY[0]~input_o\ & ((\u3|s_state.E2~q\) # ((\u3|s_state.E2A~q\ & !\u3|s_state~18_combout\)))) # (!\KEY[0]~input_o\ & (((\u3|s_state.E2A~q\ & !\u3|s_state~18_combout\))))
...
-- Equation(s):
-- \u3|s_state~22_combout\ = (\u3|s_state.E1~q\ & ((\SW[16]~input_o\) # ((\SW[17]~input_o\) # (\SW[15]~input_o\))))
...
-- Equation(s):
-- \u3|s_state~24_combout\ = ((\u3|s_state~15_combout\ & ((\u3|s_state.E3~q\) # (\u3|s_state.E0A~q\)))) # (!\u3|s_state~23_combout\)
...
-- Equation(s):
-- \u3|proc_sinc~0_combout\ = (!\SW[16]~input_o\ & !\SW[17]~input_o\)
...
-- Equation(s):
-- \u3|s_state~14_combout\ = (\KEY[0]~input_o\ & (\u3|s_state.E1~q\ & ((\SW[15]~input_o\) # (!\u3|proc_sinc~0_combout\))))
...
-- Equation(s):
-- \u3|Selector9~0_combout\ = ((!\u3|s_state.E2~q\ & \u3|timeVal\(14))) # (!\u3|s_state.E0~q\)
...
-- Equation(s):
-- \u2|s_counter~0_combout\ = (!\u3|enable_timer~q\ & (\KEY[0]~input_o\ & !\u2|Add1~0_combout\))
...
\u2|s_counter[20]~1\ : cycloneive_lcell_comb
-- Equation(s):
-- \u2|s_counter[20]~1_combout\ = ((\u3|enable_timer~q\) # (!\u2|Equal0~9_combout\)) # (!\KEY[0]~input_o\)
...
PORT MAP (
	...
	combout => \u2|s_counter[20]~1_combout\);
...
-- Equation(s):
-- \u2|s_counter~3_combout\ = (!\u3|enable_timer~q\ & (\KEY[0]~input_o\ & !\u2|Add1~4_combout\))
...
-- Equation(s):
-- \u2|s_counter~8_combout\ = (!\u3|enable_timer~q\ & (\KEY[0]~input_o\ & !\u2|Add1~14_combout\))
...
-- Equation(s):
-- \u2|s_counter~16_combout\ = (\KEY[0]~input_o\ & (!\u3|enable_timer~q\ & !\u2|Add1~30_combout\))
...
-- Equation(s):
-- \u2|s_counter~22_combout\ = (\KEY[0]~input_o\ & (!\u3|enable_timer~q\ & !\u2|Add1~42_combout\))
...
-- Equation(s):
-- \u2|s_counter~23_combout\ = (\KEY[0]~input_o\ & (!\u3|enable_timer~q\ & !\u2|Add1~44_combout\))
...
-- Equation(s):
-- \u2|s_counter~24_combout\ = (\KEY[0]~input_o\ & (!\u2|Add1~46_combout\ & !\u3|enable_timer~q\))
...
-- Equation(s):
-- \u2|Equal0~6_combout\ = (\u2|s_counter\(22) & (\u2|s_counter\(21) & (\u2|s_counter\(20) & \u2|s_counter\(23))))
...
-- Equation(s):
-- \u2|Equal0~5_combout\ = (\u2|s_counter\(18) & (\u2|s_counter\(19) & (\u2|s_counter\(16) & \u2|s_counter\(17))))
...
-- Equation(s):
-- \u2|Equal0~0_combout\ = (\u2|s_counter\(0) & (\u2|s_counter\(2) & (\u2|s_counter\(1) & \u2|s_counter\(3))))
...
-- Equation(s):
-- \u2|Equal0~1_combout\ = (\u2|s_counter\(6) & (\u2|s_counter\(4) & (\u2|s_counter\(5) & \u2|s_counter\(7))))
...
-- Equation(s):
-- \u2|Equal0~3_combout\ = (\u2|s_counter\(15) & (\u2|s_counter\(13) & (\u2|s_counter\(12) & \u2|s_counter\(14))))
...
PORT MAP (
	...
	datab => \u2|s_counter\(13),
	datac => \u2|s_counter\(12),
	datad => \u2|s_counter\(14),
	combout => \u2|Equal0~3_combout\);

-- Location: LCCOMB_X114_Y33_N20
\u2|Equal0~2\ : cycloneive_lcell_comb
-- Equation(s):
-- \u2|Equal0~2_combout\ = (\u2|s_counter\(9) & (\u2|s_counter\(8) & (\u2|s_counter\(11) & \u2|s_counter\(10))))
...
-- Equation(s):
-- \u2|Equal0~4_combout\ = (\u2|Equal0~0_combout\ & (\u2|Equal0~1_combout\ & (\u2|Equal0~3_combout\ & \u2|Equal0~2_combout\)))
...
-- Equation(s):
-- \u2|Add1~58_combout\ = \u2|s_counter\(29) $ (\u2|Add1~57\)
...
-- Equation(s):
-- \u2|Equal0~7_combout\ = (\u2|s_counter\(25) & (\u2|s_counter\(24) & (\u2|s_counter\(27) & \u2|s_counter\(26))))
...
-- Equation(s):
-- \u3|s_state~15_combout\ = (\u3|s_state.E3~q\ & (((\u3|proc_sinc~0_combout\ & !\SW[15]~input_o\)))) # (!\u3|s_state.E3~q\ & (\u2|s_cntZero~q\))
...
-- Equation(s):
-- \u3|s_state~17_combout\ = (!\u3|s_state~16_combout\ & (((\u3|proc_sinc~0_combout\ & !\SW[15]~input_o\)) # (!\u3|s_state.E1~q\)))
...
-- Equation(s):
-- \u3|s_state~18_combout\ = (((\u3|s_state~15_combout\ & !\u3|s_state.E1~q\)) # (!\KEY[0]~input_o\)) # (!\u3|s_state~17_combout\)
...
-- Equation(s):
-- \u3|s_state~19_combout\ = (\KEY[0]~input_o\ & (((\u3|s_state.E0A~q\ & !\u3|s_state~18_combout\)) # (!\u3|s_state.E0~q\))) # (!\KEY[0]~input_o\ & (((\u3|s_state.E0A~q\ & !\u3|s_state~18_combout\))))
...
-- Equation(s):
-- \u3|Selector3~0_combout\ = (\u3|s_state.E3~q\) # ((\u3|ledg~q\ & ((\u3|s_state.E0A~q\) # (\u3|s_state.E2A~q\))))
...
-- Equation(s):
-- \u0|s_divCounter~3_combout\ = (!\u0|Equal0~10_combout\ & \u0|Add0~10_combout\)
...
-- Equation(s):
-- \u0|s_divCounter~6_combout\ = (!\u0|Equal0~10_combout\ & \u0|Add0~16_combout\)
...
-- Equation(s):
-- \u0|s_divCounter~5_combout\ = (!\u0|Equal0~10_combout\ & \u0|Add0~26_combout\)
...
-- Equation(s):
-- \u0|s_divCounter~2_combout\ = (!\u0|Equal0~10_combout\ & \u0|Add0~30_combout\)
...
-- Equation(s):
-- \u0|s_divCounter~1_combout\ = (!\u0|Equal0~10_combout\ & \u0|Add0~32_combout\)
...
-- Equation(s):
-- \u0|s_divCounter~0_combout\ = (!\u0|Equal0~10_combout\ & \u0|Add0~34_combout\)
...
-- Equation(s):
-- \u0|s_divCounter~4_combout\ = (!\u0|Equal0~10_combout\ & \u0|Add0~36_combout\)
...
-- Equation(s):
-- \u0|Equal0~5_combout\ = (!\u0|s_divCounter\(26) & (!\u0|s_divCounter\(24) & (!\u0|s_divCounter\(25) & !\u0|s_divCounter\(23))))
...
-- Equation(s):
-- \u0|Equal0~8_combout\ = (!\u0|s_divCounter\(12) & (\u0|s_divCounter\(18) & (\u0|s_divCounter\(13) & !\u0|s_divCounter\(14))))
...
-- Equation(s):
-- \u0|Equal0~9_combout\ = (\u0|s_divCounter\(8) & (!\u0|s_divCounter\(7) & (\u0|s_divCounter\(4) & \u0|Equal0~8_combout\)))
...
-- Equation(s):
-- \u0|Equal0~0_combout\ = (!\u0|s_divCounter\(19) & (\u0|s_divCounter\(16) & (!\u0|s_divCounter\(20) & \u0|s_divCounter\(17))))
...
-- Equation(s):
-- \u0|Equal0~3_combout\ = (\u0|s_divCounter\(0) & (!\u0|s_divCounter\(22) & (!\u0|s_divCounter\(21) & \u0|s_divCounter\(1))))
...
PORT MAP (
	...
	datad => \u0|s_divCounter\(1),
	combout => \u0|Equal0~3_combout\);

-- Location: LCCOMB_X109_Y30_N28
\u0|Equal0~1\ : cycloneive_lcell_comb
-- Equation(s):
-- \u0|Equal0~1_combout\ = (!\u0|s_divCounter\(11) & (!\u0|s_divCounter\(9) & (!\u0|s_divCounter\(10) & \u0|s_divCounter\(15))))
...
PORT MAP (
	...
	datab => \u0|s_divCounter\(9),
	datac => \u0|s_divCounter\(10),
	datad => \u0|s_divCounter\(15),
	combout => \u0|Equal0~1_combout\);

-- Location: LCCOMB_X109_Y29_N28
\u0|Equal0~4\ : cycloneive_lcell_comb
-- Equation(s):
-- \u0|Equal0~4_combout\ = (\u0|Equal0~0_combout\ & (\u0|Equal0~2_combout\ & (\u0|Equal0~3_combout\ & \u0|Equal0~1_combout\)))
...
-- Equation(s):
-- \u0|Equal0~10_combout\ = (\u0|Equal0~5_combout\ & (\u0|Equal0~6_combout\ & (\u0|Equal0~9_combout\ & \u0|Equal0~4_combout\)))
...
-- Equation(s):
-- \u0|clkOut~0_combout\ = (\u0|s_divCounter\(12) & (!\u0|s_divCounter\(18) & (!\u0|s_divCounter\(13) & \u0|s_divCounter\(14))))
...
-- Equation(s):
-- \u0|clkOut~1_combout\ = (!\u0|s_divCounter\(8) & (\u0|s_divCounter\(7) & (!\u0|s_divCounter\(4) & \u0|clkOut~0_combout\)))
...
-- Equation(s):
-- \u0|clkOut~2_combout\ = (!\u0|Equal0~10_combout\ & ((\u0|clkOut~q\) # ((\u0|clkOut~1_combout\ & \u0|Equal0~7_combout\))))
...
-- Equation(s):
-- \u3|Selector0~0_combout\ = ((\u3|ola~q\ & ((\u3|s_state.E0A~q\) # (\u3|s_state.E2A~q\)))) # (!\u3|s_state.E0~q\)
...
-- Equation(s):
-- \u3|Selector1~0_combout\ = (\u3|s_state.E1~q\) # ((\u3|epro~q\ & ((\u3|s_state.E0A~q\) # (\u3|s_state.E2A~q\))))
...
-- Equation(s):
-- \u1|visor_uni~0_combout\ = (!\SW[17]~input_o\ & (!\SW[16]~input_o\ & (!\u3|epro~q\ & !\u3|ola~q\)))
...
-- Equation(s):
-- \u1|visor_uni~1_combout\ = (\u1|mask\(0) & ((\u3|ola~q\) # ((!\SW[15]~input_o\ & \u1|visor_uni~0_combout\)))) # (!\u1|mask\(0) & (!\SW[15]~input_o\ & (\u1|visor_uni~0_combout\)))
...
-- Equation(s):
-- \u1|visor_uni~2_combout\ = (\u3|ola~q\) # (!\u3|epro~q\)
...
-- Equation(s):
-- \u1|visor_uni~3_combout\ = (\u3|epro~q\) # ((!\SW[16]~input_o\ & (!\SW[15]~input_o\ & !\SW[17]~input_o\)))
...
\u1|visor_uni~4\ : cycloneive_lcell_comb
-- Equation(s):
-- \u1|visor_uni~4_combout\ = (\u3|ola~q\ & (\u1|mask\(0))) # (!\u3|ola~q\ & ((\u1|visor_uni~3_combout\)))
...
PORT MAP (
	...
	combout => \u1|visor_uni~4_combout\);
...
-- Equation(s):
-- \u1|visor_dez~0_combout\ = (!\u3|epro~q\ & !\SW[17]~input_o\)
...
-- Equation(s):
-- \u1|visor_dez~1_combout\ = (\u3|ola~q\) # ((\u1|visor_dez~0_combout\ & ((\SW[16]~input_o\) # (!\SW[15]~input_o\))))
...
-- Equation(s):
-- \u1|visor_dez~2_combout\ = (!\u3|epro~q\ & ((\SW[17]~input_o\) # ((!\SW[16]~input_o\ & !\SW[15]~input_o\))))
...
-- Equation(s):
-- \u1|visor_dez~4_combout\ = (\u3|ola~q\ & (((\u1|mask\(0))))) # (!\u3|ola~q\ & ((\u3|epro~q\) # ((\u3|proc_sinc~0_combout\))))
...
-- Equation(s):
-- \u1|visor_dez[4]~feeder_combout\ = \u1|visor_uni~1_combout\
...
-- Equation(s):
-- \u1|visor_dez[5]~feeder_combout\ = \u1|visor_uni~1_combout\
...
-- Equation(s):
-- \u1|visor_dez~5_combout\ = (\u3|ola~q\) # ((!\u3|epro~q\ & ((!\SW[15]~input_o\) # (!\u3|proc_sinc~0_combout\))))
...
-- Equation(s):
-- \u1|visor_cen~0_combout\ = (\u1|visor_uni~0_combout\) # ((\u3|ola~q\ & \u1|mask\(0)))
...
-- Equation(s):
-- \u1|visor_cen~1_combout\ = (\u3|ola~q\ & (((\u1|mask\(0))))) # (!\u3|ola~q\ & (!\u3|epro~q\ & ((!\SW[17]~input_o\))))
...
-- Equation(s):
-- \u1|visor_cen[3]~feeder_combout\ = \u1|visor_uni~4_combout\
...
-- Equation(s):
-- \u1|visor_cen[4]~feeder_combout\ = \u1|visor_uni~1_combout\
...
-- Equation(s):
-- \u1|visor_cen~2_combout\ = (\u3|ola~q\) # ((!\u3|epro~q\ & ((\SW[17]~input_o\) # (!\SW[16]~input_o\))))
...
-- Equation(s):
-- \u1|visor_mil~0_combout\ = (\u3|ola~q\) # ((\u3|proc_sinc~0_combout\ & (!\u3|epro~q\ & !\SW[15]~input_o\)))
...
-- Equation(s):
-- \u1|visor_mil~1_combout\ = ((\u3|ola~q\) # ((\u3|epro~q\) # (\SW[17]~input_o\))) # (!\SW[16]~input_o\)
...
-- Equation(s):
-- \u1|visor_mil~2_combout\ = (\u3|ola~q\) # (((!\SW[16]~input_o\ & !\SW[15]~input_o\)) # (!\u1|visor_dez~0_combout\))
...
-- Equation(s):
-- \u1|visor_mil~3_combout\ = (\u3|ola~q\) # ((!\u3|epro~q\ & (!\SW[16]~input_o\ & !\SW[17]~input_o\)))
